...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command }) => {
  ...
  try {
    ...
    if (globall.menugif.menuowner) {
      await conn.sendFile(
        m.chat,
        globall.menugif.menuowner,
        "danz.mp4",
        text,
        m,
        true,
        {
          ...
          contextInfo: {
            externalAdReply: {
              title: ucapan() + " " + name,
              body: wm,
              thumbnailUrl: globall.menuthumb.menuowner || global.thumb,
        ...
        m.chat,
        {
          ...
          contextInfo: {
            externalAdReply: {
              ...
              body: m.pushName,
              thumbnailUrl: globall.menuthumb.menuowner || thumb,
