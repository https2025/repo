...
`.trim();
  ...
  switch (type) {
    case "fox":
      ...
      if (new Date() - user.foxlastfeed > 60000) {
        if (user.petfood > 0) {
          user.petfood -= 1;
          user.foxexp += 20;
    ...
    case "cat":
      ...
      let _waktuc = 60000 - __waktuc;
      let waktuc = clockString(_waktuc);
      if (new Date() - user.catlastfeed > 60000) {
        if (user.petfood > 0) {
          user.petfood -= 1;
          user.catexp += 20;
    ...
    case "dog":
      ...
      let _waktua = 60000 - __waktua;
      let waktua = clockString(_waktua);
      if (new Date() - user.doglastfeed > 60000) {
        if (user.petfood > 0) {
          user.petfood -= 1;
          user.dogexp += 20;
    ...
    case "horse":
      ...
      if (new Date() - user.horselastfeed > 60000) {
        if (user.petfood > 0) {
          user.petfood -= 1;
          user.horseexp += 20;
    ...
    case "robo":
      ...
      let _wakturb = 60000 - __wakturb;
      let wakturb = clockString(_wakturb);
      if (new Date() - user.robolastfeed > 60000) {
        if (user.petfood > 0) {
          user.petfood -= 1;
          user.roboexp += 20;
