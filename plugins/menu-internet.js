...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command }) => {
  ...
  try {
    ...
    if (globall.menugif.menuinternet) {
      await conn.sendFile(
        m.chat,
        globall.menugif.menuinternet,
        "danz.mp4",
        text,
        m,
        true,
        {
          ...
          contextInfo: {
            externalAdReply: {
              title: ucapan() + " " + name,
              body: wm,
              thumbnailUrl: globall.menuthumb.menuinternet || global.thumb,
        ...
        m.chat,
        {
          ...
          contextInfo: {
            externalAdReply: {
              ...
              body: m.pushName,
              thumbnailUrl: globall.menuthumb.menuinternet || thumb,
