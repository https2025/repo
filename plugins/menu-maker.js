...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command }) => {
  ...
  try {
    ...
    if (globall.menugif.menumaker) {
      await conn.sendFile(
        m.chat,
        globall.menugif.menumaker,
        "danz.mp4",
        text,
        m,
        true,
        {
          ...
          contextInfo: {
            externalAdReply: {
              title: ucapan() + " " + name,
              body: wm,
              thumbnailUrl: globall.menuthumb.menumaker || global.thumb,
        ...
        m.chat,
        {
          ...
          contextInfo: {
            externalAdReply: {
              ...
              body: m.pushName,
              thumbnailUrl: globall.menuthumb.menumaker || thumb,
