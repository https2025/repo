...
`.trimStart(),
  ...
  footer: "╰┄┄┄┄┄┄┄┄┄┄┄┄┄〢",
  after: global?.infoo?.wm || global.wm,
};
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command }) => {
  ...
  try {
    ...
    if (global.db.data.bots.menugif.menuai) {
      await conn.sendFile(
        m.chat,
        global.db.data.bots.menugif.menuai,
        "danz.mp4",
        text,
        m,
        true,
        {
          ...
          contextInfo: {
            externalAdReply: {
              title: ucapan() + " " + name,
              body: wm,
              thumbnailUrl: global.db.data.bots.menuthumb.menuai || global.thumb,
              sourceUrl: global.db.data.bots.link.ig || sig,
              mediaType: 1,
      ...
      await conn.sendMessage(
        m.chat,
        {
          ...
          contextInfo: {
            externalAdReply: {
              title: global.db.data.bots.info.wm || wm,
              body: m.pushName,
              thumbnailUrl: global.db.data.bots.menuthumb.menuai || global.thumb,
    ...
    //await conn.sendFile(m.chat, 'https://files.catbox.moe/2sgtpu.opus', 'tes.mp3', '', m, true)
  } catch (e) {
