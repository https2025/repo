...
import { pinterest, wallpaper } from "../lib/scrape.js";
const isHent =
  /boob(s)?|18|sepon(g|k)?|desah|mia|khalifah|sexy|bikini|bugil|r34|xx(x)?|sex|porno|tete|payudara|penis|montok|ngocok|oppai|naked|bikini|sex(y|i)?|boha(y|i)?|tetek|tt|titi(t|d)?|hent(ai|ao)?|animeh|pussy|dick|xnxx|kontol|colmek|coli|cum|hot|meme(k|g)?|neocoil(l)?|yamete|kimochi|bkp|bokep|nsfw|rule(34)?|telanjang|crot|peju/i;
