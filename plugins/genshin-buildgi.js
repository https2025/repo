...
let handler = async (m, { conn, data, text, usedPrefix, command }) => {
  if (!text)
    return m.reply(
    ...
    switch (match) {
      case "Amber":
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Build Support For ${match} ${footer}`,
          m,
        );
        await delay(2000);
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Another Build Main Dps For ${match} ${footer}`,
          m,
        );
        break;
      case "Barbara":
      ...
      case "Jean":
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Build Healer For ${match} ${footer}`,
          m,
        );
        await delay(2000);
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Another Burst Dps Build For ${match} ${footer}`,
          m,
        );
        break;
      case "Kaeya":
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Build Sub Dps For ${match} ${footer}`,
          m,
        );
        await delay(2000);
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Another Support Build For ${match} ${footer}`,
          m,
        );
        await delay(2000);
        conn.sendFile(
      ...
      case "Keqing":
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Build Electro For ${match} ${footer}`,
          m,
        );
        await delay(2000);
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Another Build Physical For ${match} ${footer}`,
          m,
        );
        await delay(2000);
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Another Build Quicken For ${match} ${footer}`,
          m,
        );
        break;
      case "Klee":
      ...
      case "Lisa":
        ...
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Another Build Support For ${match} ${footer}`,
          m,
        );
        await delay(2000);
        conn.sendFile(
      ...
      case "Mona":
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Build Burst Dps For ${match} ${footer}`,
          m,
        );
        await delay(2000);
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Another Build Mona Nuke For ${match} ${footer}`,
          m,
        );
        await delay(2000);
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Another Build Mona Freeze For ${match} ${footer}`,
          m,
        );
        break;
      case "Ningguang":
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Build Main Dps For ${match} ${footer}`,
          m,
        );
        await delay(2000);
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Another Build Burst Dps For ${match} ${footer}`,
          m,
        );
        await delay(2000);
        conn.sendFile(
          ...
          "saya",
          `${match}.jpg`,
          `Here Another Build For ${match} ${footer}`,
          m,
        );
        break;
      case "Noelle":
      ...
      case "Xiangling":
        ...
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Another Build  Main DpsFor ${match} ${footer}`,
          m,
        );
        await delay(2000);
        conn.sendFile(
      ...
      case "Ganyu":
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Build Main Dps Melt For ${match} ${footer}`,
          m,
        );
        await delay(1500);
        conn.sendFile(
      ...
      case "Yanfei":
        ...
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Another Build Sub Dps For ${match} ${footer}`,
          m,
        );
        break;
      ...
      case "Gorou":
        conn.sendFile(
          m.chat,
          "https://raw.githubusercontent.com/FortOfFans/FortOfFans.github.io/main/Characters/en-US/Support/Character_Gorou.jpg",
          `${match}.jpg`,
          `Here Build For ${match} ${footer}`,
          m,
        );
      ...
      case "Yae Miko":
        ...
        conn.sendFile(
          ...
          `${match}.jpg`,
          `Here Build Aggravate For ${match} ${footer}`,
          m,
        );
        break;
      case "Kamisato Ayato":
      ...
      case "Kirara":
        conn.sendFile(
          m.chat,
          "https://raw.githubusercontent.com/FortOfFans/FortOfFans.github.io/main/Characters/en-US/Support/Character_Kirara.jpg",
          `${match}.jpg`,
          `Here Build For ${match} ${footer}`,
          m,
        );
      ...
      case "Lyney":
        conn.sendFile(
          m.chat,
          "https://raw.githubusercontent.com/FortOfFans/FortOfFans.github.io/main/sheets/Lyney_Main%20DPS.jpg",
          `${match}.jpg`,
          `Here Build For ${match} ${footer}`,
          m,
        );
      ...
      case "Lynette":
        conn.sendFile(
          m.chat,
          "https://raw.githubusercontent.com/FortOfFans/FortOfFans.github.io/main/sheets/Lynette_Support.jpg",
          `${match}.jpg`,
          `Here Build For ${match} ${footer}`,
          m,
        );
      ...
      case "Neuvillette":
        conn.sendFile(
          m.chat,
          "https://pomf2.lain.la/f/nz4220i5.jpg",
          `${match}.jpg`,
          `Here Build For ${match} ${footer}`,
          m,
        );
      ...
      case "Wriothesley":
        conn.sendFile(
          m.chat,
          "https://pomf2.lain.la/f/itnhj3e2.jpg",
          `${match}.jpg`,
          `Here Build For ${match} ${footer}`,
          m,
        );
      ...
      case "Furina":
        conn.sendFile(
          m.chat,
          "https://pomf2.lain.la/f/55t5ys5i.jpg",
          `${match}.jpg`,
          `Here Build For ${match} ${footer}`,
          m,
        );
      ...
      case "Navia":
        conn.sendFile(
          m.chat,
          "https://pomf2.lain.la/f/qrqdp5wy.jpg",
          `${match}.jpg`,
          `Here Build For ${match} ${footer}`,
          m,
        );
      ...
      case "Arlecchino":
        conn.sendFile(
          m.chat,
          "https://pomf2.lain.la/f/6dogyklb.jpg",
          `${match}.jpg`,
          `Here Build For ${match} ${footer}`,
          m,
        );
      ...
      case "Chevreuse":
        conn.sendFile(
          m.chat,
          "https://pbs.twimg.com/media/GA6auyiWEAACXrc?format=jpg&name=large",
          `${match}.jpg`,
          `Here Build For ${match} ${footer}`,
          m,
        );
